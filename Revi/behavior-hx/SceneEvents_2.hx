...
public var _canLeave:Bool;

 
 	public function new(dummy:Int, engine:Engine)
	{
		super(engine);
		nameMap.set("canLeave", "_canLeave");
_canLeave = false;
...
/* ======================== When Creating ========================= */
        scene.cameraFollow(getActor(2));
        _canLeave = false;
propertyChanged("_canLeave", _canLeave);
...
/* ======================== Group & Group ========================= */
addSceneCollisionListener(getActorGroup(4).ID + 1000000, getActorGroup(0).ID + 1000000, function(event:Collision, list:Array<Dynamic>):Void
{
if(wrapper.enabled)
{
...
{
        if((isInRegion(getActor(2), getRegion(0)) && (_canLeave == true)))
{
